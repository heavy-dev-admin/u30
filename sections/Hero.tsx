...
export default function Hero(props: HomepageSettings['hero']) {
  ...
  return (
    <div className="mx-auto w-full max-w-360 flex flex-col px-4 py-10 bg-cream gap-12.5 md:px-6.5 lg:flex-row lg:justify-between lg:items-center lg:gap-[66px] lg:pt-0 lg:pb-6.5">
